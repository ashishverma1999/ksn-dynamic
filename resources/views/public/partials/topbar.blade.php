<div class="bg-[#07192f] text-xs sm:text-sm text-slate-200 border-b border-white/10">
    <div class="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-2.5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-3 self-end sm:self-auto">
            ...
            <a href="https://wa.me/{{ $school['whatsapp'] ?? '919793856502' }}?text=Hello%20Happy%20Model%20Public%20School%2C%20I%20would%20like%20to%20know%20more%20about%20admissions." target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 text-emerald-400 hover:text-emerald-300 font-semibold text-xs transition-colors">
